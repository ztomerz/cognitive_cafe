...
set(MSG_I_FLAGS "-Itiago_pcl_tutorial:/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/msg/PlaneCoefficients.msg" NAME_WE)
add_custom_target(_tiago_pcl_tutorial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "tiago_pcl_tutorial" "/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/msg/PlaneCoefficients.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(tiago_pcl_tutorial
  "/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/msg/PlaneCoefficients.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tiago_pcl_tutorial)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/tiago_pcl_tutorial\")")
  # install generated code
  install(
