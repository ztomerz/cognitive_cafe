...
void rviz_plugin_covariance::OdometryDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OdometryDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz_plugin_covariance::OdometryDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<nav_msgs::Odometry>::staticMetaObject,
    qt_meta_stringdata_rviz_plugin_covariance__OdometryDisplay.data,
    qt_meta_data_rviz_plugin_covariance__OdometryDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
