...
void rviz_plugin_covariance::CovarianceDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CovarianceDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz_plugin_covariance::CovarianceDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<geometry_msgs::PoseWithCovarianceStamped>::staticMetaObject,
    qt_meta_stringdata_rviz_plugin_covariance__CovarianceDisplay.data,
    qt_meta_data_rviz_plugin_covariance__CovarianceDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
