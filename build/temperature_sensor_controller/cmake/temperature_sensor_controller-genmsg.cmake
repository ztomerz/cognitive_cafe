...
set(MSG_I_FLAGS "-Itemperature_sensor_controller:/home/tomer/cogrob_project/src/ros_controllers/temperature_sensor_controller/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tomer/cogrob_project/src/ros_controllers/temperature_sensor_controller/msg/ActuatorTemperatureState.msg" NAME_WE)
add_custom_target(_temperature_sensor_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "temperature_sensor_controller" "/home/tomer/cogrob_project/src/ros_controllers/temperature_sensor_controller/msg/ActuatorTemperatureState.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(temperature_sensor_controller
  "/home/tomer/cogrob_project/src/ros_controllers/temperature_sensor_controller/msg/ActuatorTemperatureState.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/temperature_sensor_controller)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/temperature_sensor_controller\")")
  # install generated code
  install(
