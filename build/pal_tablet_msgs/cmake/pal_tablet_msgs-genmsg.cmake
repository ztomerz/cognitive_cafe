...
set(MSG_I_FLAGS "-Ipal_tablet_msgs:/home/tomer/cogrob_project/src/pal_msgs/pal_tablet_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tomer/cogrob_project/src/pal_msgs/pal_tablet_msgs/msg/FunctionalityStatus.msg" NAME_WE)
add_custom_target(_pal_tablet_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pal_tablet_msgs" "/home/tomer/cogrob_project/src/pal_msgs/pal_tablet_msgs/msg/FunctionalityStatus.msg" "std_msgs/Bool:std_msgs/String"
)

get_filename_component(_filename "/home/tomer/cogrob_project/src/pal_msgs/pal_tablet_msgs/msg/RobotStatus.msg" NAME_WE)
add_custom_target(_pal_tablet_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pal_tablet_msgs" "/home/tomer/cogrob_project/src/pal_msgs/pal_tablet_msgs/msg/RobotStatus.msg" "pal_tablet_msgs/FunctionalityStatus:std_msgs/Bool:std_msgs/String"
)
...
_generate_msg_cpp(pal_tablet_msgs
  ...
  "${MSG_I_FLAGS}"
  "/home/tomer/cogrob_project/src/pal_msgs/pal_tablet_msgs/msg/FunctionalityStatus.msg;/opt/ros/noetic/share/std_msgs/cmake/../msg/Bool.msg;/opt/ros/noetic/share/std_msgs/cmake/../msg/String.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/pal_tablet_msgs
)
...
### Generating Module File
_generate_module_eus(pal_tablet_msgs
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pal_tablet_msgs
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(pal_tablet_msgs_generate_messages_eus
...
# target for backward compatibility
add_custom_target(pal_tablet_msgs_geneus)
add_dependencies(pal_tablet_msgs_geneus pal_tablet_msgs_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pal_tablet_msgs_generate_messages_eus)
...
### Generating Module File
_generate_module_nodejs(pal_tablet_msgs
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pal_tablet_msgs
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(pal_tablet_msgs_generate_messages_nodejs
...
# target for backward compatibility
add_custom_target(pal_tablet_msgs_gennodejs)
add_dependencies(pal_tablet_msgs_gennodejs pal_tablet_msgs_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS pal_tablet_msgs_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pal_tablet_msgs)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/pal_tablet_msgs
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(pal_tablet_msgs_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pal_tablet_msgs)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/pal_tablet_msgs
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(pal_tablet_msgs_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pal_tablet_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pal_tablet_msgs\")")
  # install generated code
  install(
