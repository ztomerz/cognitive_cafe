...
class PresentationActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new PresentationFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PresentationActionFeedback
    ...
    bufferOffset = PresentationFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PresentationActionFeedback
    let len;
    let data = new PresentationActionFeedback(null);
    ...
    data.feedback = PresentationFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PresentationActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = PresentationFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new PresentationFeedback()
    }
...
module.exports = PresentationActionFeedback;
