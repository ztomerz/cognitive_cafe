...
struct WifiSignalMap_
{
  ...
  _sectors_type sectors;
   ...
   typedef std::vector< ::pal_wifi_localization_msgs::WifiSignalList_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::pal_wifi_localization_msgs::WifiSignalList_<ContainerAllocator> >> _data_type;
  _data_type data;
...
bool operator==(const ::pal_wifi_localization_msgs::WifiSignalMap_<ContainerAllocator1> & lhs, const ::pal_wifi_localization_msgs::WifiSignalMap_<ContainerAllocator2> & rhs)
{
