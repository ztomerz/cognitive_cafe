...
struct WifiSignalList_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::pal_wifi_localization_msgs::WifiSignal_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::pal_wifi_localization_msgs::WifiSignal_<ContainerAllocator> >> _networks_type;
...
bool operator==(const ::pal_wifi_localization_msgs::WifiSignalList_<ContainerAllocator1> & lhs, const ::pal_wifi_localization_msgs::WifiSignalList_<ContainerAllocator2> & rhs)
{
