...
bool operator==(const ::pal_wifi_localization_msgs::GetWifiMapResponse_<ContainerAllocator1> & lhs, const ::pal_wifi_localization_msgs::GetWifiMapResponse_<ContainerAllocator2> & rhs)
{
