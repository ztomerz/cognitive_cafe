...
let MotionManagerFeedback = require('./MotionManagerFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class MotionManagerActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MotionManagerFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MotionManagerActionFeedback
    ...
    bufferOffset = MotionManagerFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MotionManagerActionFeedback
    let len;
    let data = new MotionManagerActionFeedback(null);
    ...
    data.feedback = MotionManagerFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotionManagerActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MotionManagerFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MotionManagerFeedback()
    }
...
module.exports = MotionManagerActionFeedback;
