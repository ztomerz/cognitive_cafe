...
namespace tiago_pcl_tutorial
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(segmentConfig &config, const segmentConfig &max, const segmentConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const segmentConfig &config1, const segmentConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, segmentConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const segmentConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, segmentConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const segmentConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const segmentConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, segmentConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.image = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(segmentConfig::AbstractParamDescriptionConstPtr(new segmentConfig::ParamDescription<int>("image", "int", 0, "A PointCloud2 origin param which is edited via an enum", "{'enum': [{'name': 'original_image', 'type': 'int', 'value': 0, 'srcline': 15, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'original image', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'filtered_image', 'type': 'int', 'value': 1, 'srcline': 16, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'filtered image', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to choose origin PointCloud2'}", &segmentConfig::image)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(segmentConfig::AbstractParamDescriptionConstPtr(new segmentConfig::ParamDescription<int>("image", "int", 0, "A PointCloud2 origin param which is edited via an enum", "{'enum': [{'name': 'original_image', 'type': 'int', 'value': 0, 'srcline': 15, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'original image', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'filtered_image', 'type': 'int', 'value': 1, 'srcline': 16, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'filtered image', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to choose origin PointCloud2'}", &segmentConfig::image)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.method = 0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.method = 3;
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(segmentConfig::AbstractParamDescriptionConstPtr(new segmentConfig::ParamDescription<int>("method", "int", 0, "A PointCloud2 origin param which is edited via an enum", "{'enum': [{'name': 'Plane', 'type': 'int', 'value': 0, 'srcline': 20, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'Plane', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cylindrical', 'type': 'int', 'value': 1, 'srcline': 21, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'Cylindrical', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Euclidean', 'type': 'int', 'value': 2, 'srcline': 22, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'Euclidean', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to choose method'}", &segmentConfig::method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(segmentConfig::AbstractParamDescriptionConstPtr(new segmentConfig::ParamDescription<int>("method", "int", 0, "A PointCloud2 origin param which is edited via an enum", "{'enum': [{'name': 'Plane', 'type': 'int', 'value': 0, 'srcline': 20, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'Plane', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Cylindrical', 'type': 'int', 'value': 1, 'srcline': 21, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'Cylindrical', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Euclidean', 'type': 'int', 'value': 2, 'srcline': 22, 'srcfile': '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg', 'description': 'Euclidean', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to choose method'}", &segmentConfig::method)));
...
//#line 15 "/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_original_image = 0;
//#line 16 "/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_filtered_image = 1;
//#line 20 "/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_Plane = 0;
//#line 21 "/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
      const int segment_Cylindrical = 1;
//#line 22 "/home/tomer/cogrob_project/src/tiago_tutorials/tiago_pcl_tutorial/cfg/segment.cfg"
