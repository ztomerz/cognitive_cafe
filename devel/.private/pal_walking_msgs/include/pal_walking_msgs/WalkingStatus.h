...
bool operator==(const ::pal_walking_msgs::WalkingStatus_<ContainerAllocator1> & lhs, const ::pal_walking_msgs::WalkingStatus_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.hip_reference_pose == rhs.hip_reference_pose &&
    lhs.foot_reference_pose == rhs.foot_reference_pose &&
    lhs.zmp_reference == rhs.zmp_reference;
}
