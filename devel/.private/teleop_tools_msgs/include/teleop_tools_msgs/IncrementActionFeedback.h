...
bool operator==(const ::teleop_tools_msgs::IncrementActionFeedback_<ContainerAllocator1> & lhs, const ::teleop_tools_msgs::IncrementActionFeedback_<ContainerAllocator2> & rhs)
{
