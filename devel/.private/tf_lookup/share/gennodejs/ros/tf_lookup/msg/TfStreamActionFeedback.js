...
let TfStreamFeedback = require('./TfStreamFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class TfStreamActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TfStreamFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TfStreamActionFeedback
    ...
    bufferOffset = TfStreamFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TfStreamActionFeedback
    let len;
    let data = new TfStreamActionFeedback(null);
    ...
    data.feedback = TfStreamFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TfStreamActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TfStreamFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TfStreamFeedback()
    }
...
module.exports = TfStreamActionFeedback;
