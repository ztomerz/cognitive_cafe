...
let TfLookupFeedback = require('./TfLookupFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class TfLookupActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TfLookupFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TfLookupActionFeedback
    ...
    bufferOffset = TfLookupFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TfLookupActionFeedback
    let len;
    let data = new TfLookupActionFeedback(null);
    ...
    data.feedback = TfLookupFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TfLookupActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TfLookupFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TfLookupFeedback()
    }
...
module.exports = TfLookupActionFeedback;
