...
struct ListMotionsResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::play_motion_msgs::MotionInfo_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::play_motion_msgs::MotionInfo_<ContainerAllocator> >> _motions_type;
