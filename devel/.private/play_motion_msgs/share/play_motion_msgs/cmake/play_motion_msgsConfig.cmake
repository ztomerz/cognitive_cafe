...
if("TRUE" STREQUAL "TRUE")
  set(play_motion_msgs_SOURCE_PREFIX /home/tomer/cogrob_project/src/play_motion/play_motion_msgs)
  set(play_motion_msgs_DEVEL_PREFIX /home/tomer/cogrob_project/devel/.private/play_motion_msgs)
  ...
  set(play_motion_msgs_INSTALL_PREFIX /home/tomer/cogrob_project/install)
...
if(NOT "/home/tomer/cogrob_project/devel/.private/play_motion_msgs/include " STREQUAL " ")
  set(play_motion_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/tomer/cogrob_project/devel/.private/play_motion_msgs/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'play_motion_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tomer/cogrob_project/src/play_motion/play_motion_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT play_motion_msgs_NUM_DUMMY_TARGETS)
      set(play_motion_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::play_motion_msgs::wrapped-linker-option${play_motion_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR play_motion_msgs_NUM_DUMMY_TARGETS "${play_motion_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::play_motion_msgs::wrapped-linker-option${play_motion_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND play_motion_msgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tomer/cogrob_project/devel/.private/play_motion_msgs/lib;/home/tomer/cogrob_project/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(play_motion_msgs_EXPORTED_TARGETS ${${play_motion_msgs_dep}_EXPORTED_TARGETS})
endforeach()
