...
class GetUserInputActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GetUserInputFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetUserInputActionFeedback
    ...
    bufferOffset = GetUserInputFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetUserInputActionFeedback
    let len;
    let data = new GetUserInputActionFeedback(null);
    ...
    data.feedback = GetUserInputFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetUserInputActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GetUserInputFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GetUserInputFeedback()
    }
...
module.exports = GetUserInputActionFeedback;
