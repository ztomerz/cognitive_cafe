...
class ExecFootstepsActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ExecFootstepsFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ExecFootstepsActionFeedback
    ...
    bufferOffset = ExecFootstepsFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ExecFootstepsActionFeedback
    let len;
    let data = new ExecFootstepsActionFeedback(null);
    ...
    data.feedback = ExecFootstepsFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ExecFootstepsFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ExecFootstepsActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ExecFootstepsFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ExecFootstepsFeedback()
    }
...
module.exports = ExecFootstepsActionFeedback;
