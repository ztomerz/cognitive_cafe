...
if("TRUE" STREQUAL "TRUE")
  set(play_motion_SOURCE_PREFIX /home/tomer/cogrob_project/src/play_motion/play_motion)
  set(play_motion_DEVEL_PREFIX /home/tomer/cogrob_project/devel/.private/play_motion)
  ...
  set(play_motion_INSTALL_PREFIX /home/tomer/cogrob_project/install)
...
if(NOT "/home/tomer/cogrob_project/src/play_motion/play_motion/include " STREQUAL " ")
  set(play_motion_INCLUDE_DIRS "")
  set(_include_dirs "/home/tomer/cogrob_project/src/play_motion/play_motion/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'play_motion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tomer/cogrob_project/src/play_motion/play_motion/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tomer/cogrob_project/devel/.private/play_motion/lib;/home/tomer/cogrob_project/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(play_motion_EXPORTED_TARGETS ${${play_motion_dep}_EXPORTED_TARGETS})
endforeach()
