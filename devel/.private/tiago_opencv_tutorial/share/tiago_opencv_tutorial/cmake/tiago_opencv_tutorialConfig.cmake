...
if("TRUE" STREQUAL "TRUE")
  set(tiago_opencv_tutorial_SOURCE_PREFIX /home/tomer/cogrob_project/src/tiago_tutorials/tiago_opencv_tutorial)
  set(tiago_opencv_tutorial_DEVEL_PREFIX /home/tomer/cogrob_project/devel/.private/tiago_opencv_tutorial)
  ...
  set(tiago_opencv_tutorial_INSTALL_PREFIX /home/tomer/cogrob_project/install)
...
if(NOT "/home/tomer/cogrob_project/devel/.private/tiago_opencv_tutorial/include " STREQUAL " ")
  set(tiago_opencv_tutorial_INCLUDE_DIRS "")
  set(_include_dirs "/home/tomer/cogrob_project/devel/.private/tiago_opencv_tutorial/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tiago_opencv_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tomer/cogrob_project/src/tiago_tutorials/tiago_opencv_tutorial/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tomer/cogrob_project/devel/.private/tiago_opencv_tutorial/lib;/home/tomer/cogrob_project/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(tiago_opencv_tutorial_EXPORTED_TARGETS ${${tiago_opencv_tutorial_dep}_EXPORTED_TARGETS})
endforeach()
