...
namespace diff_drive_controller
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(DiffDriveControllerConfig &config, const DiffDriveControllerConfig &max, const DiffDriveControllerConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const DiffDriveControllerConfig &config1, const DiffDriveControllerConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, DiffDriveControllerConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const DiffDriveControllerConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, DiffDriveControllerConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const DiffDriveControllerConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const DiffDriveControllerConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, DiffDriveControllerConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
