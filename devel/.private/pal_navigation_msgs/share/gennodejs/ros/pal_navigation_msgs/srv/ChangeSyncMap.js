...
class ChangeSyncMapRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChangeSyncMapRequest
    ...
    bufferOffset = _arraySerializer.string(obj.sources, buffer, bufferOffset, null);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChangeSyncMapRequest
    let len;
    let data = new ChangeSyncMapRequest(null);
    ...
    data.sources = _arrayDeserializer.string(buffer, bufferOffset, null)
    return data;
  }
  ...
  static datatype() {
    ...
    return 'pal_navigation_msgs/ChangeSyncMapRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'ee5b62bd043daac548944c4e6af1dddb';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChangeSyncMapRequest(null);
...
class ChangeSyncMapResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChangeSyncMapResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChangeSyncMapResponse
    let len;
    let data = new ChangeSyncMapResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChangeSyncMapResponse(null);
...
module.exports = {
  Request: ChangeSyncMapRequest,
  Response: ChangeSyncMapResponse,
  md5sum() { return '4b38ea74e243895872e69689a25f87ad'; },
  datatype() { return 'pal_navigation_msgs/ChangeSyncMap'; }
};
