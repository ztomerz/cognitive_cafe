...
class SetMapConfigurationRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetMapConfigurationRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetMapConfigurationRequest
    let len;
    let data = new SetMapConfigurationRequest(null);
  ...
  static md5sum() {
    ...
    return 'a5dcef8070cccd91b551a47f386077df';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetMapConfigurationRequest(null);
...
class SetMapConfigurationResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
    }
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetMapConfigurationResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetMapConfigurationResponse
    let len;
    let data = new SetMapConfigurationResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetMapConfigurationResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: SetMapConfigurationRequest,
  Response: SetMapConfigurationResponse,
  md5sum() { return 'a5dcef8070cccd91b551a47f386077df'; },
  datatype() { return 'pal_navigation_msgs/SetMapConfiguration'; }
};
