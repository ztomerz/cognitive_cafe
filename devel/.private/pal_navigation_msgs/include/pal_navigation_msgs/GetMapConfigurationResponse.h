...
bool operator==(const ::pal_navigation_msgs::GetMapConfigurationResponse_<ContainerAllocator1> & lhs, const ::pal_navigation_msgs::GetMapConfigurationResponse_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::pal_navigation_msgs::GetMapConfigurationResponse_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xa5dcef8070cccd91ULL;
  static const uint64_t static_value2 = 0xb551a47f386077dfULL;
};
