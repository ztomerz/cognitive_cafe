...
class MapConfiguration(genpy.Message):
  _md5sum = "409650328c300e91b40a6c396d0d0783"
...
"""
  __slots__ = ['numberOfSubMaps','highways','pois','vo','zoi','ramps','poigroups','visualLocDb','navigation_map','user_map','transform']
  _slot_types = ['int32','pal_navigation_msgs/Highways[]','pal_navigation_msgs/POI','pal_navigation_msgs/POI','pal_navigation_msgs/POI','pal_navigation_msgs/POI','pal_navigation_msgs/POIGroup[]','pal_navigation_msgs/VisualLocDB','nav_msgs/OccupancyGrid','sensor_msgs/Image','pal_navigation_msgs/NiceMapTransformation']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       numberOfSubMaps,highways,pois,vo,zoi,ramps,poigroups,visualLocDb,navigation_map,user_map,transform
