...
struct Statistics_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::pal_statistics_msgs::Statistic_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::pal_statistics_msgs::Statistic_<ContainerAllocator> >> _statistics_type;
