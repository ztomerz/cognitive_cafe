...
if("TRUE" STREQUAL "TRUE")
  set(pal_gripper_SOURCE_PREFIX /home/tomer/cogrob_project/src/pal_gripper/pal_gripper)
  set(pal_gripper_DEVEL_PREFIX /home/tomer/cogrob_project/devel/.private/pal_gripper)
  ...
  set(pal_gripper_INSTALL_PREFIX /home/tomer/cogrob_project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pal_gripper' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pal_gripper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tomer/cogrob_project/src/pal_gripper/pal_gripper/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pal_gripper_NUM_DUMMY_TARGETS)
      set(pal_gripper_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pal_gripper::wrapped-linker-option${pal_gripper_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pal_gripper_NUM_DUMMY_TARGETS "${pal_gripper_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pal_gripper::wrapped-linker-option${pal_gripper_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pal_gripper_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tomer/cogrob_project/devel/.private/pal_gripper/lib;/home/tomer/cogrob_project/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pal_gripper_dep}_FOUND)
      find_package(${pal_gripper_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pal_gripper_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(pal_gripper_EXPORTED_TARGETS ${${pal_gripper_dep}_EXPORTED_TARGETS})
endforeach()
