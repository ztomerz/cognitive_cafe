...
class EmptyActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type EmptyActionFeedback
    ...
    bufferOffset = EmptyFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type EmptyActionFeedback
    let len;
    let data = new EmptyActionFeedback(null);
    ...
    data.feedback = EmptyFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EmptyActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = EmptyFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new EmptyFeedback()
    }
...
module.exports = EmptyActionFeedback;
