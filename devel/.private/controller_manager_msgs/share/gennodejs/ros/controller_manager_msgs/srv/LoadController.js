...
class LoadControllerRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LoadControllerRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LoadControllerRequest(null);
...
class LoadControllerResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LoadControllerResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new LoadControllerResponse(null);
    if (msg.ok !== undefined) {
      resolved.ok = msg.ok;
    }
    else {
